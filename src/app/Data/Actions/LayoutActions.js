...
export const ActionList = [
  { name: types.Layout.SetSideBarItems, action: SetSideBarItemsDispatch, propName: 'LayoutSetSideBarItems' },
  { name: types.Layout.ClearSideBarItems, action: ClearSideBarItemsDispatch, propName: 'LayoutClearSideBarItems' }
]
