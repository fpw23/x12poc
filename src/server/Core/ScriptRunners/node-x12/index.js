...
function defaultSerializationOptions(options, canOverwrite = true) {
    ...
    options.segmentHeaders = options.segmentHeaders === undefined ? X12SegmentHeader_1.StandardSegmentHeaders : options.segmentHeaders;
...
})(X12SegmentHeaderLoopStyle = exports.X12SegmentHeaderLoopStyle || (exports.X12SegmentHeaderLoopStyle = {}));
...
class X12Segment {
    ...
    constructor(tag = '', options) {
        ...
        this.options = X12SerializationOptions_1.defaultSerializationOptions(options, false);
        this.parseIndex = -1;
    }
    /**
...
class X12Transaction {
    ...
    setHeader(elements, options) {
        options = options !== undefined
            ? X12SerializationOptions_1.defaultSerializationOptions(options, false)
            : this.options;
        this.header = new X12Segment_1.X12Segment(X12SegmentHeader_1.STSegmentHeader.tag, options);
    ...
    _setTrailer(options) {
        options = options !== undefined
            ? X12SerializationOptions_1.defaultSerializationOptions(options)
            : this.options;
        this.trailer = new X12Segment_1.X12Segment(X12SegmentHeader_1.STSegmentHeader.trailer, options);
...
class X12Interchange {
    ...
    setHeader(elements, options) {
        options = options !== undefined
            ? X12SerializationOptions_1.defaultSerializationOptions(options)
            : this.options;
        this.header = new X12Segment_1.X12Segment(X12SegmentHeader_1.ISASegmentHeader.tag, options);
        this.header.setElements(elements);
        this._setTrailer(options);
    }
    /**
    ...
    _setTrailer(options) {
        options = options !== undefined
            ? X12SerializationOptions_1.defaultSerializationOptions(options)
            : this.options;
        this.trailer = new X12Segment_1.X12Segment(X12SegmentHeader_1.ISASegmentHeader.trailer, options);
...
class X12FunctionalGroup {
    ...
    setHeader(elements, options) {
        options = options !== undefined
            ? X12SerializationOptions_1.defaultSerializationOptions(options)
            : this.options;
        this.header = new X12Segment_1.X12Segment(X12SegmentHeader_1.GSSegmentHeader.tag, options);
        this.header.setElements(elements);
        this._setTrailer(options);
    }
    /**
    ...
    _setTrailer(options) {
        options = options !== undefined
            ? X12SerializationOptions_1.defaultSerializationOptions(options)
            : this.options;
        this.trailer = new X12Segment_1.X12Segment(X12SegmentHeader_1.GSSegmentHeader.trailer, options);
...
class X12Parser extends stream_1.Transform {
    ...
    constructor(strict, encoding, options) {
        ...
        this._strict = strict;
        this._options = X12SerializationOptions_1.defaultSerializationOptions(options, allowOptionOverwrite);
    ...
    _parseSegments(edi, segmentTerminator, elementDelimiter) {
        ...
        for (let i = 0, l = 0, c = 0; i < edi.length; i++) {
            ...
            if (!tagged && (edi[i].search(/\s/) === -1) && (edi[i] !== elementDelimiter) && (edi[i] !== segmentTerminator)) {
                ...
                const loopPathUnboundTagIndex = this.findLastIndex(loopPath, (t) => { return currentSegment.tag === t.tag && t.type === X12SegmentHeader_1.X12SegmentHeaderLoopStyle.Unbounded; });
...
class X12QueryEngine {
    ...
    _evaluateStarReferenceQueryPart(interchange, functionalGroup, transaction, segments) {
        const results = new Array();
        for (let i = 0; i < segments.length; i++) {
            const segment = segments[i];
            if (segment === null || segment === undefined) {
...
class X12Generator {
    ...
    constructor(jsen, options) {
        ...
        if (jsen.options !== undefined) {
            this.options = X12SerializationOptions_1.defaultSerializationOptions(jsen.options, false);
        }
