...
export const ActionList = [
  { name: types.Router.SetNewLocation, action: SetNewLocationDispatch, propName: 'RouterSetNewLocation' },
  { name: types.Router.AddPathName, action: AddPathNameDispatch, propName: 'RouterAddPathName' },
  { name: types.Router.ClearPathNames, action: ClearPathNames, propName: 'RouterClearPathNames' }
]
