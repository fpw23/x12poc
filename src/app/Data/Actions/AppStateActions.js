...
export const UpdateArrayValueDispatch = (dispatch) => {
  return (key, prop, filterFunction, updateFunction, modifyFunction) => {
    dispatch(UpdateArrayValue(key, prop, filterFunction, updateFunction, modifyFunction))
  }
}
...
export const ActionList = [
  { name: types.AppState.ClearValue, action: ClearValueDispatch, propName: 'AppStateClearValue' },
  { name: types.AppState.SetValue, action: SetValueDispatch, propName: 'AppStateSetValue' },
  { name: types.AppState.AppendArrayValue, action: AppendArrayValueDispatch, propName: 'AppStateAppendArray' },
  { name: types.AppState.UpdateArrayValue, action: UpdateArrayValueDispatch, propName: 'AppStateUpdateArray' },
  { name: types.AppState.ClearArrayValue, action: ClearArrayValueDispatch, propName: 'AppStateClearArray' }
]
